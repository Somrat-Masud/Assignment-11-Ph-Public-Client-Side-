...
const ScienceBookData = ({booking}) => {
    const {title,AuthorName,catagory,img,price} = booking;
    return (
        ...
        <div className="card-body items-center text-center">
            <h1 className="text-2xl font-semibold"> Name:{title}</h1>
...
export default ScienceBookData;